...
public class aadsData {
	...
	public String AADS_ADD_CONTACT_USER1_FULL_NAME	= "Franklyn Rush";
	public String SMGR_ADDR 		= excelData.getLabInfo(lab, 4, 1);
	public String SMGR_WEB_ADDR	 	= "https://"+SMGR_ADDR+"/network-login/";
...
//	public String AADS_USER_GROUP = "CN=Users,CN=Builtin,DC=aam1,DC=com";
	...
	public String AADS_VERIFY_SMGR_CONTACT_LIST_ON_SMGR		= "user";
	public String LASTNAME_PRIVATE_CONTACT					= "Automation";
	public String FIRSTNAME_PRIVATE_CONTACT					= "private";
	public String AADS_ADD_CONTACT_SEARCH_BY_LAST_NAME2		= "73910";
	public String AADS_ADD_CONTACT_USER_2_FULL_NAME			= "AMM 73910";
	//public String SM_ADDRESS = excelData.getLabInfo(lab, 5, 1);
	//public String SIP_CONTROL_LIST = SM_ADDRESS + ":5061;transport=TLS";
	...
	public String AADS_ADD_CONTACT_DISPLAY_IN_CONTACT_LIST_1		= "user01 smgr";
	public String AADS_ADD_CONTACT_SEARCH_BY_FIRST_NAME1				= "user01";
	
	public String AADS_ADD_CONTACT_DISPLAY_IN_CONTACT_LIST_2		= "test01 smgr";
	...
	public String WiniumURL(int i) {
		String Winium = "http://"+excelData.getNetworkData("windows", i+1, 1)+":9999";	
		return Winium;
	}
	
	public String WinAppURL(int i) {
		String WinApp = "http://"+excelData.getNetworkData("windows", i+1, 1)+":4724";	
		return WinApp;
	}
}
