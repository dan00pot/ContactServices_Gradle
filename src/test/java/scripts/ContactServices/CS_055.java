...
/*################################################################
 * CS-055 - Deleting  contacts on Android client by searching LDAP contacts
 ...
 * ###############################################################*/
	...
	Logger logger = LogManager.getLogger("CS_055");
	...
	@Before
	public void beforeTest_ContactService_055() throws Exception {
		logger.info("beforeTest_ContactService_055 starting...\n");
		androidClientDriver = driverMgnt.createAndroidClientDriver();
		reports = ExtentManager.GetExtent();
		logger.info("beforeTest_ContactService_055 completed...\n");
	}
	
	@Test
	public void testContactService_055() throws Exception {
		logger.info("testContactService_055 - Starting\n");
		Sresult = reports.createTest("[ACA] Contact Services CS_055, remove Contact in contact list Info DN  - Android");
		try {
		//	androidClient.navigateToContactScreen(androidClientDriver);
			...
			fail("ContactService_055 - Failed - Exception occurs: "	+ exception.toString());
		}
	}
