...
/*###########################################################################################
 * CS-041 - Adding  contacts on iOS client by searching SMGR contacts
	"Objective: To verify that contacts are added by searching SMGR contacts iOS client logged via Auto Configuration
...
############################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("CS_041");
	...
	@Before
	public void beforeTest_ContactService_041() throws Exception {
		logger.info("beforeTest ContactService_041 starting...\n");
		iOSClientDriver = driverMgnt.createIOSClientDriver();
		logger.info("beforeTest ContactService_041 completed...\n");
	}
