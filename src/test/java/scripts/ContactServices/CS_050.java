...
/*##################################################################################
 * CS-050 - Editing  contacts on iOS client by searching SMGR contacts
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("CS_050");
	...
	@Before
	public void beforeTest_ContactService_050() throws Exception {
		logger.info("beforeTest_ContactService_050 starting...\n");
		iOSClientDriver = driverMgnt.createIOSClientDriver();
		logger.info("beforeTest_ContactService_050 completed...\n");
	}
	
	@Test
	public void testContactService_050() throws Exception {
		logger.info("test ContactService_050 - Starting\n");
		try {
			...
			fail("ContactService_050 - Failed - Exception occurs: "	+ exception.toString());
		}
	}
