...
//		public By SETTING_SCREEN_ACCOUNT_TAB_PHONE_SERVICE_CONNECTED_TXT				=	By.id("com.avaya.android.flare:id/voip_service_connected_as_user");
	    ...
	    //																																				DUY NGUYEN
	    //################################################################################################################################################################
	    public By SEARCH_RESULT_USER_BTN(String name)											{return By.xpath("//XCUIElementTypeStaticText[contains(@name,'"+name+"')]");}
	    public By CONTACT_SEARCH_CANCEL_BTN													=	By.xpath("//XCUIElementTypeButton[@name='Search']/preceding-sibling::XCUIElementTypeButton");
	    public By CONTACT_DETAIL_REMOVE_CONTACT 											=	By.xpath("//XCUIElementTypeStaticText[@name='Remove Contact']");
