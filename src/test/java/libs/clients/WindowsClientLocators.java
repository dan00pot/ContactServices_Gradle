...
//	
//####################################################################################################################################################################################
	public By CONTACT_TAB_SCREEN_NEW_CONTACT_BTN 									=	 By.name("New Contact");
	...
	public By SEARCH_TEXT_BOX = By.xpath("//Edit[@AutomationId='SearchTextBoxMain']");
...
//	public By ADD_CONTACT_SCREEN_AMM_ADDRESS_TXT				=	By.xpath("//*[@AutomationId = 'PART_TextBoxEx'][2]");
	...
	public By ADD_CONTACT_SCREEN_ADD_CONTACT_PLUS_BTN			=	By.xpath("Add New Contact");
...
//	public By CONTACT_LIST_CANCLE_SEARCH_BTN	=	By.id("UnifiedSearchCancelButton");
	public By CONTACT_LIST_CANCLE_SEARCH_BTN = By.xpath("//Button[@Name='Cancel'][@AutomationId='UnifiedSearchCancelButton']");
//	public By CONTACT_LIST_CANCLE_SEARCH_BTN = By.xpath("//*[@Name='Cancel']");
	...
	public By CHOICE_CONTACT_LIST									=	By.xpath("//Button[@AutomationId='ContactsTabItemViewModelHeaderDropDownButton']");
