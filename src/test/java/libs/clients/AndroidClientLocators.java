...
//		return By.xpath("//*[@resource-id='com.avaya.android.flare:id/searchHeaderTitle' and contains(@text,'Enterprise')]/following-sibling::android.widget.FrameLayout//android.widget.TextView[@resource-id='com.avaya.android.flare:id/contact_item_name' and @text='"+name+"']");
//	}
//	
	public By enterprise_result_by_name(String name) {return By.xpath("//android.widget.TextView[contains(@text,'Enterprise Directory')]/../following-sibling::android.widget.FrameLayout//*[contains(@text,'"+name+"')]");}
	...
	//DUY
	//#####################################################################################################################################################################################
	public By ADD_CONTACT_SCREEN_EMAIL_TXT 							= 	By.xpath("//android.widget.EditText[contains(@text,'Address is')]");
	public By ADD_CONTACT_SCREEN_FIRST_NAME_TXT 					= 	By.xpath("//android.widget.EditText[@text = 'First Name']");
	public By ADD_CONTACT_SCREEN_NUMBER_PHONE_TXT 					= 	By.xpath("//android.widget.EditText[contains(@text,'Number')]");
	public By ADD_CONTACT_SCREEN_DONE_BTN 							= 	By.id("com.avaya.android.flare:id/button_done");
	public By CONTACT_DETAIL_SCREEN_REMOVE_CONTACT_BTN 				= 	By.xpath("//android.widget.TextView[@text = 'Remove Contact']");
	public By CONTACT_DETAIL_SCREEN_NAVIGATE_UP_BTN 				= 	By.xpath("//android.widget.ImageButton[@content-desc = 'Navigate up']");
	public By CONTACT_LIST 											= 	By.id("com.avaya.android.flare:id/contacts_list_view");
	public By CONTACT_TAB_USER_NAME(String user) 					  	{return By.xpath("//android.widget.TextView[@text = '" + user + "']");}
	public By CONTACT_SCREEN_SEARCH_TXT 							= 	By.id("com.avaya.android.flare:id/unifiedContactsSearchEditText");
	public By CONTACT_SCREEN_LIST_CONTACT_ITEM(String DN) 				{return By.xpath("(//*[@resource-id='com.avaya.android.flare:id/contact_item_name'][contains(@text,'"+DN+"')])[1]");}
	public By CONTACT_SCREEN_LIST_CONTACT_ITEM 						=	By.xpath("(//*[@resource-id='com.avaya.android.flare:id/contact_item_name'])[1]");
	public By CONTACT_TAB_CONTACTS_EXIST_BUTTON						= 	By.id("android:id/button2");
	public By CONTACT_DETAIL_SCREEN_ADD_CONTACT_BTN 				= 	By.xpath("//android.widget.TextView[@text = 'Add to Contacts']");
	public By CONTACT_DETAIL_EDIT 									=	By.id("com.avaya.android.flare:id/menu_edit");
	public By TAB_SEND_AN_EMAIL_CONTACT_DETAILS 					=   By.xpath("//*[@text='Send a Message']");
