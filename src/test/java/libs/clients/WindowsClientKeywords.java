...
//			throw new Exception("resetApplication - Failed - Exception occurs: " + exception);
	...
	public void mainWindowsNavigateToContactTab (WindowsDriver winRootDriver) throws Exception{
		...
		try {
			winClientDriver = createWinHandleDriver(winRootDriver, "Avaya Equinox");
			if(selenium.isElementExisted(winRootDriver, windowsClient.CHOICE_CONTACT_LIST)) {
...
//			Thread.sleep(2000);
	...
	public boolean addPrivateContact(WindowsDriver winRootDriver, String firstname, String lastname, String phone, String address) throws Exception{
		...
		try {
			...
			selenium.clickElement(winClientDriver, windowsClient.CONTACT_TAB_SCREEN_NEW_CONTACT_BTN);
...
//			selenium.scollToElementWin(winRootDriver, By.xpath("//Pane[@ClassName='ScrollViewer']"), "AutomationId","PART_TextBoxEx");
			...
			selenium.clickElement(winClientDriver, windowsClient.ADD_CONTACT_SCREEN_ADD_CONTACT_BTN);}
			Thread.sleep(5000);
//			selenium.waitUntilElementVisible(winClientDriver, windowsClient.ADD_CONTACT_SCREEN_ADD_CONTACT_BTN);
			selenium.waitUntilElementVisible(winClientDriver, windowsClient.CHOICE_CONTACT_LIST);
