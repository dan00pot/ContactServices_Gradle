...
public class Selenium {
	...
	//Boss...................................................................................
	public void scrollAndroid(AndroidDriver androidClientDriver, String str) throws Exception{
		try {
			logger.info("scoll - starting...\n");
			androidClientDriver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\""+str+"\").instance(0))");
		} catch (Exception ex) {
			
			logger.error("scoll - Failed - Exception occurs: "
					+ ex + "\n");
			throw new Exception(
					"scoll - Failed - Exception occurs: " + ex);
		}
	}
	public void clickBackAndroid(AndroidDriver androidClientDriver) throws Exception{
		try {
			logger.info("click back - starting...\n");
...
//	
//	public void scollToElementWin(WebDriver driver, By element, String atribute, String equal)
//			throws Exception {
//		try {
//			WebElment element
